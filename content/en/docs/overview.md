...
description: "An overview of the Notary v2 project"
type: docs
weight: 1
---
...
![Notary v2 scenarios](/docs/notary-e2e-scenarios.svg)
...
![Notary v2 dependent projects](/docs/oss-project-sequence.svg)
...
Throughout 2020, the group agreed upon a set of [Notary v2 requirements]({{< ref "/docs/concepts/requirements" >}}) and [scenarios][nv2-scenarios] enabling spec and design conversations to be grounded in a set of [goals]({{< ref "/docs/concepts/requirements" >}}) and [non-goals][non-requirements].
...
The Notary v2 workflow ([outlined in Scenario #0]({{< ref "/docs/concepts/scenarios#scenario-0-build-publish-consume-enforce-policy-deploy" >}}))
