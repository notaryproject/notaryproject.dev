...
description: "How Notary persists verification content with reverse lookup in an OCI-based registry"
type: docs
weight: 6
---
...
To address [Notary Scenario #6: Multiple Signatures]({{< ref "/docs/concepts/scenarios#scenario-6-multiple-signatures" >}}), an artifact must be capable of having additional signatures (verifications) be added.
